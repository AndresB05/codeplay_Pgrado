...
- [ ] 1.6 Documentar la 0015 en `supabase/README.md`, migración por migración como las anteriores, incluido el motivo de que sean vistas y no políticas y qué expone el roster.
