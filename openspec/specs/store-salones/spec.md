...
**Y escuchar no es el único disparador, desde `panel-al-dia`.** Hay cambios de
los que la base no puede avisar: el progreso de un alumno no se publica —Realtime
entrega un cambio a quien la política de esa tabla deja leer la fila, y la suya
sólo alcanza a su dueño—, así que el tutor nunca recibiría el aviso de que uno de
sus alumnos jugó. Que quien mira vuelva a mirar —abriendo una pantalla, o
devolviendo el foco a la ventana— vale entonces como aviso, y provoca la misma
