...
la asignación de misiones a un salón, y desde la 0021 la publicación en vivo de
los cambios de tres de esas tablas. Los requisitos describen un sistema en
funcionamiento.
...
`docs/CONTEXT.md` §2.7, cerradas en el paso 11. Lo único que queda fuera es la
carrera del `for update` del cupo, probada funcionalmente y no bajo concurrencia.
