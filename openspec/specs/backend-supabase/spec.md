...
los cambios de tres de esas tablas, y desde la 0022 **un segundo camino de
ingreso a un salón**: las dos funciones que generan y canjean una invitación.
Los requisitos describen un sistema en funcionamiento.
